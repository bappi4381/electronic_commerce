...
<div class="space-y-6 max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-black tracking-tight text-slate-900 leading-none">Edit User</h1>
            <p class="text-sm font-bold text-slate-400 uppercase tracking-[0.2em] mt-2">Modify existing customer account</p>
        </div>
