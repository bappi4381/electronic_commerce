...
@section('title', 'Create Administrative Role')
...
<div class="space-y-10 pb-20">
    ...
    <div class="flex items-center gap-5">
        ...
        <div>
            <h1 class="text-3xl font-black tracking-tight text-slate-900 leading-none">CREATE ADMINISTRATIVE ROLE</h1>
            <p class="text-xs font-black text-slate-400 uppercase tracking-[0.25em] mt-3">Establish a new access profile with custom permissions</p>
        </div>
    </div>
    ...
    {{-- Create Form --}}
    <form action="{{ route('roles.store') }}" method="POST" class="space-y-10">
        @csrf
        <div class="grid grid-cols-1 gap-10">
            ...
            <div class="bg-white rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/40 p-10 space-y-8">
                ...
                <div class="max-w-xl space-y-2">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. Content Moderator, Support Agent" 
