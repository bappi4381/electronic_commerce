...
@section('title', 'Forgot Password - Recovery')
...
<div class="bg-slate-900 py-16 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 relative z-10 text-center">
        <h1 class="text-4xl lg:text-5xl font-black text-white tracking-tighter uppercase mb-4">Password Recovery</h1>
        <div class="flex items-center justify-center gap-2 text-slate-400 font-bold text-xs uppercase tracking-widest">
            ...
            <a href="{{ route('user.auth.login') }}" class="hover:text-primary transition-colors">Login</a>
            <i class="bi bi-chevron-right text-[10px]"></i>
    ...
    <div class="max-w-md mx-auto px-4">
        <div class="bg-white rounded-[40px] shadow-xl shadow-slate-200/50 border border-slate-100 p-10 lg:p-12 relative overflow-hidden">
            ...
            <div class="relative z-10">
                <h3 class="text-2xl font-black text-slate-900 tracking-tighter uppercase mb-2">Forgot Password?</h3>
                <p class="text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-10">Enter your email and we'll send you a link to reset your password.</p>
                ...
                <div class="mt-12 pt-8 border-t border-slate-100 text-center">
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                        ...
                        <a href="{{ route('user.auth.login') }}" class="text-primary hover:underline ml-2">Back to Login</a>
                    </p>
                </div>
            </div>
        </div>
